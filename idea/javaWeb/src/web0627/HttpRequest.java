...
public class HttpRequest {
    ...
    public static HttpRequest build(InputStream inputStream) throws IOException {
        ...
        //此处的逻辑中，不能把bufferedReader写到try()中
        // 一旦写进去之后，意味着bufferedReader 就会被关闭，会影响到clientSocket的状态
        // 等到最后整个请求处理完了再统一关闭。
        ...
        if(pos != -1) {
            //看看URL中是否有？，如果没有，就说明不带参数，也就不用解析了
            //此处的parameters是希望包含整个参数部分的内容
            //pos 表示？的下标
            //   /index.html?a=10&b=20
            //parameters的结果就相当于是a=10&b=20
