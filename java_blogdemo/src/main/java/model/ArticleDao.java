...
public class ArticleDao {
    ...
    public List<Article> selectAll() {
        ...
        try {
            ...
            while(resultSet.next()) {
                ...
                //此处由于没有从数据库中读取content字段，这个字段暂时先不设置
    ...
    public static void main(String[] args) {
        ...
        article.setContent("我是正文2我是正文2我是正文2我是正文2我是正文2我是正文2我是正文2我是正文2我是正文2我是正文2我是正文2我是正文2我是正文2");
        article.setUserId(1);
